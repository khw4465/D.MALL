...
<c:set var="Year" value="${birthYear}"/>
<c:set var="Month" value="${birthMonth}"/>
<c:set var="Day" value="${birthDay}"/>
<html>
<head>
...
<script type="text/javascript" src="<c:url value='/js/modifyInfo.js'/>"></script>
</body>
<%--자스 파일 분리했음--%>
<script>
