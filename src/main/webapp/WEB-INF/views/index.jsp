...
<!-- The dots/circles -->
<div style="text-align:center" class="includeItem">
    <span class="dot" onclick="currentSlide(1)"></span>
    <span class="dot" onclick="currentSlide(2)"></span>
    <span class="dot" onclick="currentSlide(3)"></span>
</div>
    <div class="includeItem"><jsp:include page="newProduct.jsp" /></div>
<%--    금주의 베스트 신상품--%>
    <div class="includeItem"><jsp:include page="popularCate.jsp" /></div>
    <%--    금주의 베스트 신상품--%>
